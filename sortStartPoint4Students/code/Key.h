...
class Key
{
    public:
        ...
        std::string getText() const { return key; };
        ...
        Value* getValuePtr() { return valueTail; };
        // post: pointer to this key's first value is returned
        
        void setValuePtr(Value* value) { valueTail = value; };
